...
// As of March 12, 2026, GitHub graciously decided that students no longer deserve
// access to Sonnet or Opus "so we can keep Copilot free and accessible for millions
// of students around the world" — while simultaneously making it worse for those students.
// Luckily, we can read. And build from source.
export enum AutoModeModelPreference {
	Default = 'default',
	// "No longer available for self-selection under the GitHub Copilot Student Plan" 🙂
	ClaudeSonnet46 = 'claude-sonnet-4.6',
	// Same fate. RIP. (Gone but not forgotten — we remember you in this enum.)
...
export namespace ConfigKey {
	...
	*/
	...
	/**
	 * Override Auto to prefer a specific Claude 4.6 model family when available.
	 * GitHub says students can't have this. We disagree. This setting exists. Use it.
	 */
	export const AutoModePreferredModel = defineSetting<AutoModeModelPreference>('chat.autoMode.preferredModel', ConfigType.Simple, AutoModeModelPreference.Default);
